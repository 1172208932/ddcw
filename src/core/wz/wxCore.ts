...
class wxCore {
    ...
    //默认登陆界面
    private loginView: ui.view.LoginviewUI = null;
    //1=全屏显示
    //2=背景黑遮罩
    ...
    public initVideoAD(key: string): void {
        ...
        if (this.mVideoAD == null && Main.app.is_wx) {
